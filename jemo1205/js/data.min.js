...
var QArendingFn = {
  ...
  indexNumber: 1,
  ResultCount: 0,
  QaNAnRender: function QaNAnRender(no) {
    var QaRender = document.getElementById('qa_render');
    QaRender.innerHTML = "".concat(AnData[no].qa);
  },
  AnClickData: function AnClickData(no, result) {
    var YesBtn = document.getElementById('yes_btn');
    var NoBtn = document.getElementById('no_btn');
    var NumberUl = document.getElementById('num');
    var Numbers = document.querySelectorAll('.an_number');
    ...
    if (this.indexNumber <= 9) {
      ...
      YesBtn.innerHTML = "<img src=\"images/qa_yes.gif\" alt=\"yes_btn\" onclick=\"QArendingFn.AnClickData(".concat(this.indexNumber, ",'yes')\">");
      NoBtn.innerHTML = "<img src=\"images/qa_no.gif\" alt=\"no_btn\" onclick=\"QArendingFn.AnClickData(".concat(this.indexNumber, ",'no')\">");
    } else {
      if (this.ResultCount < 4) {
        NumberUl.style.display = 'none';
        popUpOpen("A");
        this.ResultCode = "A"; // this.resultRender("A")
      } else {
        NumberUl.style.display = 'none';
        popUpOpen("B");
        this.ResultCode = "B"; // this.resultRender("B")
      }
    }
  },
  ResultCode: "",
  ...
  resultPoint: 0,
  pointResult: function pointResult(no, point) {// this.resultPoint += point
  },
  resultRender: function resultRender(result) {
    var ResultRender = document.getElementById('qa_render_bg');
...
function popUpOpen(result, mode) {
  var SelectBox = document.getElementById('reqmemo');
