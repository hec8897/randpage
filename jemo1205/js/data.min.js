  ...
  var QArendingFn = {
    ...
    AnClickData: function AnClickData(no, result) {
      ...
      if (this.indexNumber <= 9) {
        ...
        YesBtn.innerHTML = "<img src=\"images/qa_yes.png\" alt=\"yes_btn\" onclick=\"QArendingFn.AnClickData(".concat(this.indexNumber, ",'yes')\">");
        NoBtn.innerHTML = "<img src=\"images/qa_no.png\" alt=\"no_btn\" onclick=\"QArendingFn.AnClickData(".concat(this.indexNumber, ",'no')\">");
      } else {
