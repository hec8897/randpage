...
var layoutRender = {
    headerHtml: function () {
        var data = [{
                h3: "도전을 두려워 하지 않고 오직 고객만족을 위한",
                h2: "변화를 선도하는 투게더 인스가 되겠습니다."
            },
            {
                h3: "보험에 관한 다양한 정보를 제공하며",
                h2: "고객님의 궁금증을 해결해드리겠습니다."
            },
            {
            ...
            {
                h3: "기존의 경영의 틀을 벗어나 미래 사업에",
                h2: "새로운 변화를 가져올 투게더인스"
            }
        ]
        getQueryString()
        ...
        if (pagekey == 0) {
            ...
            if (conkey == 1) {
                MainRedner.innerHTML = `
                                    <div class='m0-con${conkey}'>
                                        ...
                                        <div class='banner banner-con-0'>
                                            <h3>최상의 서비스와 경쟁력 향상을 위해 더욱 노력하는 기업</h3>
                                            <h4>투게더 인스</h4>
                                        </div>
                ...
                MainRedner.innerHTML = ` 
                                    <div class='m0-con${conkey}'>
                                        <h2>미션</h2>
                                        <h3>고객의 현재 그리고 미래를 함께하는 <span>투게더인스</span></h3>
                                        <p class='margin_point'>투게더 인스는 언제나 고객과 함께 성장하며 새로운 가치창출을 위해 한발짝 앞서나가겠습니다.</p>
                ...
                MainRedner.innerHTML = `
                                    <div class='m0-con${conkey}'>
                                        ...
                                        <p>보다 나은 고객의 삶과 미래를 위한 영원한 동반자, 투게더인스가 되겠습니다.</p>
                                        <div class='banner'>
                                            <div class='line1'></div>
        ...
        if (pagekey == 1) {
            ...
            if (conkey == 1) {
                ...
                MainRedner.innerHTML = `
                                        ...
                                        <p>- 인보험(생명보험) : 사람에게 발생하는 사고에 대해 보장하는 보험</p>
                                        <p>- 물보험(손해보험) : 재산이나 기타의 물건에 발생하는 사고에 대해 보장하는 보험</p>

                                        <h4>경영주체에 따른 분류</h4>
                                        <p>- 공영보험 : 국가 또는 공공단체가 공공복지를 목적으로 경영하는 보험</p>
                                        <p>- 민영보험 : 보험업자에 의해 영리를 목적으로 경영하는 보험</p>

                                        <h4>보험의 책임에 따른 분류</h4>
                                        <p>- 원보험 : 보험가입자와 보험자의 최초로 계약된 보험</p>
                                        <p>- 재보험 : 원보험자가 부담해야 하는 보험 계약상의 책임의 일부 또는 전부를 다시 다른 보험자에게 인계한 보험</p>
                                        <p>- 공동보험 : 둘 이상의 보험자간 보험 목적을 공동으로 인수하는 보험</p>
                                        <p>- 중복보험 : 동일한 목적물 및 기간에 많은 보험자와 보험계약이 체결되어 총보험 금액이 보험 가액을 초과하는 보험</p>

                                        <h4>보험금 보상방법에 따른 분류</h4>
                                        <p>- 손해보험(평가보험) : [실손해액X (보험금액/보험가액)] 공식으로 지급 보험금을 산출하는 보험</p>
                                        <p>- 정액보험 : 계약상의 일정 금액을 보상해 주는 보험</p>
                ...
                MainRedner.innerHTML = `
                                        ...
                                        <h3>교통사고 처리 순서</h3>
                                        <ul class='info'>
                                            <li><span>1</span>사고가나면 피해자부터 신속히 구조(지혈, 인공호흡 등 응급처치 시행)</li>
                                            <li><span>2</span>사고현장 보존(스프레이 또는 사진기를 이용/목격자 연락처 확보)</li>
                                            <li><span>3</span>경찰관(서)에 교통사고 발생 신고(사고 장소,사상자 수, 피해 정도를 신고)</li>
    ...
    con4Render: function (pagekey) {
        ...
        if (pagekey == 3) {
            MainRedner.innerHTML = `
                                    <div class='m4-con'>
                                        <h2>인재 채용</h2>
                                        <h3>투게더 인스에서 긍정적이고 진취적인 우수한 인재를 상시 모집하고 있습니다.</h3>
                                        <h4>서로를 존중하며 신뢰하는 조직문화를 지향하는 투게더인스와 함께 미래를 함께 하실 전문인재의 많은 지원과 관심 바랍니다.</h4>
                                        <div class='join_box1'>
                                            <h3>모집분야</h3>
                                            <p>보험전문가(생명보험, 손해보험, 변액보험)</p>
                                        </div>
