...
var layoutRender = {
  headerHtml: function headerHtml() {
    var data = [{
  ...
  conRender: function conRender(pagekey, conkey) {
  ...
  con2Render: function con2Render(pagekey, conkey) {
    var MainRedner = document.getElementById('con_render');
  ...
  con3Render: function con3Render(pagekey, conkey) {},
  con4Render: function con4Render(pagekey) {
    var MainRedner = document.getElementById('con_render');
