    ...
    DataRendFn: function () {
        ...
        xhttp.onreadystatechange = function () {
            if (this.readyState == 4 && this.status == 200) {
                ...
                //    let Activation = result[0].Activation
                Activation = 7
...
`,
    ...
    NoneDataHtmlRender: function () {
        ...
        window.onload = function () { //로딩시 이미지 랜딩
            if (smMedia.matches == true) {
                headerImg.style.backgroundImage = `url(img/header/header-tit-sm-0.jpg)`;
                mobannerRedner()
            } else if (mdMedia.matche== true) {
                headerImg.style.backgroundImage = `url(img/header/header-tit-md-0.jpg)`;
                mobannerRedner()
            } else {
                headerImg.style.backgroundImage = `url(img/header/header-tit-0.jpg)`;
