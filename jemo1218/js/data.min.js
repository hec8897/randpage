...
var dataRender = {
  ...
  DataRendFn: function DataRendFn() {
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        result = returnJson.filter(function (x) {
          return x.idx == key;
  ...
  useTabKey: function useTabKey() {
    ...
    NavRending.innerHTML = "".concat(MenuNameR2);
    MoNavRending.innerHTML = "".concat(MoMenuNameR2);
    ...
    if (PCMedia.matches == true) {
      for (var i = 1; i < NavListClass.length; i++) {
        NavListClass[i].style.width = "calc(1140px/".concat(NavListClass.length - 1, ")");
      }
  ...
  NavActivation: function NavActivation(thistag) {
  ...
  MoListActivation: function MoListActivation(Datakey) {
    $(".nav_list").attr('id', '');
  ...
  HomeRendingFn: function HomeRendingFn() {
    ...
    section3.innerHTML = ""; // Section3.innerHTML = `<div class="wrap">
  ...
  cancerRendingFn: function cancerRendingFn() {
    var Section1 = document.getElementById('section1');
    var Section2 = document.getElementById('section2');
    var Section3 = document.getElementById('section3');
    var Panel1 = document.getElementById('panel-1');
  ...
  diseaseRendingFn: function diseaseRendingFn() {
    var Section1 = document.getElementById('section1');
    var Section2 = document.getElementById('section2');
    var Section3 = document.getElementById('section3');
    var Panel1 = document.getElementById('panel-1');
  ...
  dementRendingFn: function dementRendingFn() {
    var Section1 = document.getElementById('section1');
    var Section2 = document.getElementById('section2');
    var Section3 = document.getElementById('section3');
    var Panel1 = document.getElementById('panel-1');
  ...
  carRendingFn: function carRendingFn() {
    var Section1 = document.getElementById('section1');
    var Section2 = document.getElementById('section2');
    var Section3 = document.getElementById('section3');
    var Panel1 = document.getElementById('panel-1');
  ...
  DataHtmlRender: function DataHtmlRender() {
    var data = result[0];
    ...
    document.title = "Beyond Money BmCompany ".concat(data.name);
    CflagName = "".concat(data.name);
    NameSpot.innerHTML = "".concat(data.name, " ").concat(data.spot);
    ComentArea.innerHTML = "".concat(data.coment);

    window.onload = function () {
      //로딩시 이미지 랜딩
      if (smMedia.matches == true) {
        headerImg.style.backgroundImage = "url(".concat(data.headerSmimg, ")");
        mobannerRedner();
      } else if (mdMedia.matche == true) {
        headerImg.style.backgroundImage = "url(".concat(data.headerMdimg, ")");
        mobannerRedner();
      } else {
        headerImg.style.backgroundImage = "url(".concat(data.headerimg, ")");
      }
    }();
    ...
    photoArea.style.backgroundImage = "url(".concat(data.profilephoto, ")");

    if (ResumY5 != null) {
      resumeRedner5.innerHTML = "<div class='year'>".concat(ResumY5, "</div>\n                                       <div class='desc'>").concat(ResumD5, "</div>");
    }

    if (ResumY4 != null) {
      resumeRedner4.innerHTML = "<div class='year'>".concat(ResumY4, "</div>\n                                       <div class='desc'>").concat(ResumD4, "</div>");
    }

    if (ResumY3 != null) {
      resumeRedner3.innerHTML = "<div class='year'>".concat(ResumY3, "</div>\n                                       <div class='desc'>").concat(ResumD3, "</div>");
    }

    if (ResumY2 != null) {
      resumeRedner2.innerHTML = "<div class='year'>".concat(ResumY2, "</div>\n                                       <div class='desc'>").concat(ResumD2, "</div>");
    }

    if (ResumY1 != null) {
      resumeRedner1.innerHTML = "<div class='year'>".concat(ResumY1, "</div>\n                                       <div class='desc'>").concat(ResumD1, "</div>");
    }
  },
  NoneDataHtmlRender: function NoneDataHtmlRender() {
    var data = result[0];
    var headerImg = document.getElementById('header_img_render'); // var NameSpot = document.getElementById('name_spot');
    // var ComentArea = document.getElementById('coment_render');
    // var photoArea = document.getElementById('photo');
    // var resumeRedner1 = document.getElementById('resume1');
    // var resumeRedner2 = document.getElementById('resume2');
    ...
    window.onload = function () {
      ...
      if (smMedia.matches == true) {
        ...
        headerImg.style.backgroundImage = "url(img/header/header-tit-0.jpg)"; // headerImg.style.backgroundImage = `url(${data.headerimg})`;
      }
    }();
...
formRootInsert = function formRootInsert(Root) {
  var FormRoot = ["home", "gender", "baby", "cancer", "disease", "dementia", "car"];
...
function insertData() {
  ...
  data = {
    ...
    key: params.key // cflag: CflagName
    ...
    xhttp.onreadystatechange = function () {
      if (this.readyState == 4 && this.status == 200) {
        ...
        if (InputreturnJson.result == 'ok') {
          alert('상담신청이 완료되었습니다 :)'); // location.reload();
        } else {
          alert('no');
        }
      }
